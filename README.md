...
- 다양한 자료구조를 사용하여 문제 해결

| 문제                                                     | 난이도 | 해결 여부 | 해결 링크 |
| -------------------------------------------------------- | ------ | --------- | --------- |
| [회전하는 큐](https://www.acmicpc.net/problem/1021)      | 실버 3 |           |           |
...
- DFS
  ...
  - cf) 백트래킹
    - DFS에서 더 이상 정답이 아니라고 판단되는 부분은 탐색하지 않도록 가지를 치며 탐색하는 방법
- BFS
  - 너비우선탐색으로 완전탐색이나 최단경로를 찾을 때 유리
...
| [네트워크](https://school.programmers.co.kr/learn/courses/30/lessons/43162) | Level 3 |           | [:a:](https://github.com/kim003512/Algorithm_JAVA/blob/master/Algorithm_JAVA/src/%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%A8%B8%EC%8A%A4/Lv3/%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC.java) |
...
#### :white_check_mark:백트래킹

| 문제                                                     | 난이도 | 해결 여부 | 해결 링크 |
| -------------------------------------------------------- | ------ | --------- | --------- |
| [연산자 끼워넣기](https://www.acmicpc.net/problem/14888) | 실버 1 |           |           |
| [N-Queen](https://www.acmicpc.net/problem/9663)          | 골드 4 |           |           |
| [스타트와 링크](https://www.acmicpc.net/problem/14889)   | 실버 2 |           |           |
| [스도쿠](https://www.acmicpc.net/problem/2580)           | 골드 4 |           |           |
| [2048](https://www.acmicpc.net/problem/12100)            | 골드 2 |           |           |
| [가르침](https://www.acmicpc.net/problem/1062)           | 골드 4 |           |           |



<br>

#### :white_check_mark:동적 계획법(Dynamic Programming)

- 완전 탐색으로 풀었을 때 시간 초과가 나는 경우(N이 큰 경우) DP를 주로 이용

| 문제                                                 | 난이도 | 해결 여부 | 해결 링크 |
| ---------------------------------------------------- | ------ | --------- | --------- |
| [1,2,3 더하기](https://www.acmicpc.net/problem/9095) | 실버 3 |           |           |
| [정수 삼각형](https://www.acmicpc.net/problem/1932)  | 실버 1 |           |           |
| [점프](https://www.acmicpc.net/problem/1890)         | 실버 1 |           |           |
| [동전 1](https://www.acmicpc.net/problem/2293)       | 골드 5 |           |           |
| [퇴사](https://www.acmicpc.net/problem/14501)        | 실버 3 |           |           |

| 문제                                                         | 난이도  | 해결 여부 | 해결 링크 |
| ------------------------------------------------------------ | ------- | --------- | --------- |
| [N으로 표현](https://school.programmers.co.kr/learn/courses/30/lessons/42895) | Level 3 |           |           |
| [정수 삼각형](https://school.programmers.co.kr/learn/courses/30/lessons/43105) | Level 3 |           |           |
| [등굣길](https://school.programmers.co.kr/learn/courses/30/lessons/42898) | Level 3 |           |           |
| [사칙연산](https://school.programmers.co.kr/learn/courses/30/lessons/1843) | Level 4 |           |           |
| [도둑질](https://school.programmers.co.kr/learn/courses/30/lessons/42897) | Level 4 |           |           |
...
#### :white_check_mark:탐욕법(Greedy)

| 문제                                                         | 난이도  | 해결 여부 | 해결 링크 |
| ------------------------------------------------------------ | ------- | --------- | --------- |
| [체육복](https://school.programmers.co.kr/learn/courses/30/lessons/42862) | Level 1 |           |           |
| [조이스틱](https://school.programmers.co.kr/learn/courses/30/lessons/42860) | Level 2 |           |           |
...
| [섬 연결하기](https://school.programmers.co.kr/learn/courses/30/lessons/42861) | Level 3 |           |           |
| [단속카메라](https://school.programmers.co.kr/learn/courses/30/lessons/42884) | Level 3 |           |           |



<br>

#### :white_check_mark:이분 탐색

| 문제                                                         | 난이도  | 해결 여부 | 해결 링크 |
| ------------------------------------------------------------ | ------- | --------- | --------- |
| [입국심사](https://school.programmers.co.kr/learn/courses/30/lessons/43238) | Level 3 |           |           |
| [징검다리](https://school.programmers.co.kr/learn/courses/30/lessons/43236) | Level 4 |           |           |



<br>

#### :white_check_mark:그래프
